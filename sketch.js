...
function setup() {
	...
	bob2=new Bob(180,500,50,50);
	bob3=new Bob(260,500,50,50);
	bob4=new Bob(340,500,50,50);
	bob5=new Bob(420,500,50,50);

	rope1=new Rope(bob1.body,{x:100,y:100})
	rope2=new Rope(bob2.body,{x:180,y:100})
    rope3=new Rope(bob3.body,{x:260,y:100})
    rope4=new Rope(bob4.body,{x:340,y:100})
    rope5=new Rope(bob5.body,{x:420,y:100})
    Engine.run(engine);
